...
begin
  ...
  where name = 'Year 3 / Year 4 Standard'
  limit 1;
  ...
  cross join (
    values
      ...
      ('Dismissal', '15:00'::time, '15:15'::time, 'dismissal', 13)
  ...
  from (
    values
      ...
      ('Lesson 4', '10:20'::time, '11:00'::time, 'lesson', 6),
      ('Lesson 5', '11:00'::time, '11:40'::time, 'lesson', 7),
      ('Lesson 6', '11:40'::time, '12:20'::time, 'lesson', 8),
      ('Pastoral Time', '12:20'::time, '12:30'::time, 'other', 9),
      ('Dismissal', '12:30'::time, '12:45'::time, 'dismissal', 10)
  ) as period_list(label, start_time, end_time, block_type, sort_order);
end $$;
...
begin
  ...
  values
    (v_template_id, 'wednesday', 'CCA Breaktime', '15:00'::time, '15:15'::time, 'break', 13),
    (v_template_id, 'wednesday', 'CCA', '15:15'::time, '16:10'::time, 'other', 14),
    (v_template_id, 'wednesday', 'CCA Dismissal', '16:10'::time, '16:30'::time, 'dismissal', 15);
end $$;
